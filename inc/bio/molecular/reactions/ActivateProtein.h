...
/**
 * ActivateProtein is a chemical::Reaction that takes a Protein [0] and activates it (operator()).
 */
class ActivateProtein :
	public chemical::Reaction,
	public physical::Class<ActivateProtein>
{
public:
	/**
	 *
