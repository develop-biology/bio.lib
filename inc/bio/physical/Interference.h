 ...
 * For example, Intereference could cause one Wave to cancel out another by setting the first to 0 or false; this would be like destructive interference. Another Interference could cause the same 2 Waves to add together, like constructive interference. <br />
 * To accomodate Waves of arbitrary complexity (i.e. the number of Wave components), Interference can be recursive. <br />
...
public: 
     ...
     */
    Superposition GetSuperpositionFor(const Id& symmetry) const;
     ...
     */
    Interference* GetInterferenceFor(const Id& symmetry) const;
     ...
     */
    void SetSuperpositionFor(const Id& symmetry, const Superposition& superposition);
     ...
     */
    void SetInterferenceFor(const Id& symmetry, Interference* interference);

protected:

    /**
     * The Superposition for each Id. <br />
     */
    class SuperSymmetry
    {
    public:
        SuperSymmetry(const Id& symmetry, const Superposition& superposition = 0, Interference* interference = NULL) :
            mSymmetry(symmetry),
    ...
    /**
     * Internal map of Symmetry Id to Superposition pairs. <br />
     */
    Arrangement<SuperSymmetry*> mSuperSymmetries;
};
