...
public:
	 ...
	 */
	BIO_DISAMBIGUATE_ALL_CLASS_METHODS(physical, Average)
	
	/**
	 * @param applyTo The superposition to apply this Collapse to.
	 */
	Average(const Superposition& applyTo = superposition::Average());
