...
public:
	 ...
	 */
	BIO_DISAMBIGUATE_ALL_CLASS_METHODS(physical, Highest)
	
	/**
	 * @param applyTo The superposition to apply this Collapse to.
	 */
	Highest(const Superposition& applyTo = superposition::Highest());
