...
class LastToWrite :
	public physical::Class< LastToWrite >,
	public Collapse
{
public:
	 ...
	 */
	BIO_DISAMBIGUATE_ALL_CLASS_METHODS(physical, LastToWrite)
	
	/**
	 * @param applyTo The superposition to apply this Collapse to.
	 */
	LastToWrite(const Superposition& applyTo = superposition::LastToWrite());
