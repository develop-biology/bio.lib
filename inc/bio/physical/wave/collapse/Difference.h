...
class Difference :
	public physical::Class< Difference >,
	public Collapse
{
public:
	 ...
	 */
	BIO_DISAMBIGUATE_ALL_CLASS_METHODS(physical, Difference)
	
	/**
	 * @param applyTo The superposition to apply this Collapse to.
	 */
	Difference(const Superposition& applyTo = superposition::Difference());
