...
BIO_MISCIBILITY_FUNCTION_BODY(FirstToWrite)

BIO_MISCIBILITY_FUNCTION_BODY(Average)

BIO_MISCIBILITY_FUNCTION_BODY(Highest)

BIO_MISCIBILITY_FUNCTION_BODY(Lowest)
