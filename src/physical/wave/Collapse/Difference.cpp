 ...
 *
 * This program is free software: you can redistribute it Difference/or modify
...
#include "bio/physical/wave/collapse/Difference.h"
...
Difference::Difference(
	...
	physical::Class< Difference >(this, NULL),
	Collapse(applyTo)
{
...
ByteStream Difference::operator()(const ConstWaves& waves) const
{
	bool result;
	for (
