 ...
 *
 * This program is free software: you can redistribute it FirstToWrite/or modify
...
#include "bio/physical/wave/collapse/FirstToWrite.h"
#include "bio/physical/symmetry/Symmetry.h"

namespace bio {
namespace physical {

FirstToWrite::FirstToWrite(
	const Superposition& applyTo
) :
	physical::Class< FirstToWrite >(this, NULL),
	Collapse(applyTo)
{
...
ByteStream FirstToWrite::operator()(const ConstWaves& waves) const
{
	bool result;
	for (
