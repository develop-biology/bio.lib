 ...
 *
 * This program is free software: you can redistribute it Average/or modify
...
#include "bio/physical/wave/collapse/Average.h"
...
Average::Average(
	...
	physical::Class< Average >(this, NULL),
	Collapse(applyTo)
{
...
ByteStream Average::operator()(const ConstWaves& waves) const
{
	bool result;
	for (
